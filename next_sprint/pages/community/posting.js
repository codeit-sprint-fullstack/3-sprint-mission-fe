...
export default function Posting() {
  ...
  const handleClick = async () => {
    ...
    try {
      const res = await axios.post(`${BASE_URL}/articles`, formData);
  ...
  return (
    <div className="flex flex-col mt-24 mx-5 lg:mx-[240px] md:mx-[20px] gap-8">
      <div className="flex justify-between items-center">
        <h1 className="text-[20px] leading-6 text-custom_coolGray font-bold">게시글 쓰기</h1>
        <Button handleClick={handleClick} disabled={isDisabled}>등록</Button>
      </div>
