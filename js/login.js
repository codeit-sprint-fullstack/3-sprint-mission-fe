...
function inter1(e) {
    const email_contain = e.target.closest('.email-contain');
    ...
    if (e.target.classList.contains('input-Email')) {
        ...
        if (email_contain) {
            if (email_err) {
                email_contain.style.border = '2px solid red';
            } else {
                email_contain.style.border = '';
            }
        }
        button_disable();
    }
...
function inter2(e) {
    const password_contain = e.target.closest('.password-contain');
    ...
    if (e.target.classList.contains('input-password')) {
        ...
        if (password_contain) {
            if (password_error) {
                password_contain.style.border = '2px solid red';
            } else {
                password_contain.style.border = '';
            }
        }
        button_disable();
    }
